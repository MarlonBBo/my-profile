...
export function Projects(){
    ...
    const project: Project[] = [
        ...
        },
        {
          id: "3",
          title: "Portfolio",
          description: "Portfolio criado para apresentar um pouco mais dos meus projetos e algumas informações pessoais",
    ...
    return(        
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 p-4 gap-4">
              ...
              <a
                ...
                target="_blank"
              >
                <div className="rounded-lg border border-zinc-700 bg-card text-card-foreground shadow-sm overflow-hidden">
                  <Image
                    src={project.image}
                    alt={project.title}
                    width={500}
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                      {project.techs.map((tech, index) => (
                        <span key={index} className=" text-xs border-2 border-zinc-700 px-2.5 py-0.5 font-semibold bg-zinc-700 rounded-full">
                          {tech}
                        </span>
                      ))}
                    </div>
